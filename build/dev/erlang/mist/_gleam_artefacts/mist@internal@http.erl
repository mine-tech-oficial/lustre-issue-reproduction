...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(TIV)) -> gleam@http@response:response(TIV).
...
?DOC(false).
-spec add_date_header(gleam@http@response:response(TIM)) -> gleam@http@response:response(TIM).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(TIP)) -> gleam@http@response:response(TIP).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(TIS)) -> gleam@http@response:response(TIS).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(TJA)) -> gleam@http@response:response(TJA)).
