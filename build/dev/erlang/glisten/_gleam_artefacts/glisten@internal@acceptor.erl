...
-type pool(RXV, RXW) :: {pool,
        fun((RXV, glisten@internal@handler:loop_message(RXW), glisten@internal@handler:connection(RXW)) -> glisten@internal@handler:next(RXV, glisten@internal@handler:loop_message(RXW))),
        integer(),
        gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(RXW)))),
        fun((glisten@internal@handler:connection(RXW)) -> {RXV,
            gleam@option:option(gleam@erlang@process:selector(RXW))}),
        gleam@option:option(fun((RXV) -> nil)),
        glisten@transport:transport(),
...
-spec start(
    ...
    gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(RXY))))
) -> {ok,
