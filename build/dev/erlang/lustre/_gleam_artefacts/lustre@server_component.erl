...
-spec element(
    list(lustre@vdom@vattr:attribute(OYS)),
    list(lustre@vdom@vnode:element(OYS))
) -> lustre@vdom@vnode:element(OYS).
...
-spec include(lustre@vdom@vattr:attribute(OZE), list(binary())) -> lustre@vdom@vattr:attribute(OZE).
...
-spec subject(lustre:runtime(OZK)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(OZK)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(OZS))
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(OZW))
) -> lustre@runtime@server@runtime:message(OZW).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(PAA)) -> nil)
) -> lustre@runtime@server@runtime:message(PAA).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(PAD)) -> nil)
) -> lustre@runtime@server@runtime:message(PAD).
...
-spec select(
    fun((fun((PAI) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(PAI))
) -> lustre@effect:effect(PAI).
select(Sel) ->
