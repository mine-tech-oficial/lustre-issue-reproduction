...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(HFP)),
    list(lustre@vdom@vnode:element(HFP))
) -> lustre@vdom@vnode:element(HFP).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HFV)),
    list(lustre@vdom@vnode:element(HFV))
) -> lustre@vdom@vnode:element(HFV).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HGB)),
    list(lustre@vdom@vnode:element(HGB)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(HGB).
...
-spec fragment(list(lustre@vdom@vnode:element(HGL))) -> lustre@vdom@vnode:element(HGL).
fragment(Children) ->
...
-spec unsafe_raw_html(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(HGP)),
    binary()
) -> lustre@vdom@vnode:element(HGP).
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(HGU))
) -> lustre@vdom@vnode:element(HGU).
...
-spec map(lustre@vdom@vnode:element(HGY), fun((HGY) -> HHA)) -> lustre@vdom@vnode:element(HHA).
map(Element, F) ->
...
-spec wrap_document(lustre@vdom@vnode:element(HHM)) -> lustre@vdom@vnode:element(HHM).
wrap_document(El) ->
