...
-type client_message(IUR) :: {mount,
        ...
        lustre@vdom@vnode:element(IUR),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IUR)), lustre@vdom@vnode:element(IUR))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(IUR),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IUR)), lustre@vdom@vnode:element(IUR))} |
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(IUX),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IUX)), lustre@vdom@vnode:element(IUX))
) -> client_message(IUX).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(IVB),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IVB)), lustre@vdom@vnode:element(IVB))
) -> client_message(IVB).
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(IVY),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IVY)), lustre@vdom@vnode:element(IVY))
) -> gleam@json:json().
...
-spec mount_to_json(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(IVV),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(IVV)), lustre@vdom@vnode:element(IVV))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
