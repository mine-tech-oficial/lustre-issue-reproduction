...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(MSK)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(MSK), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(MSF),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MSF), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(MSV)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(MSV), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(MSQ),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MSQ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(MRZ)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(MRZ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(MRU),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MRU), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(MRP),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MRP), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(MRK), 'query'()) -> {ok,
        lustre@vdom@vnode:element(MRK)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(MTS)),
    selector()
) -> list(lustre@vdom@vnode:element(MTS)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(MTO), selector()) -> list(lustre@vdom@vnode:element(MTO)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(MUB)),
    selector()
) -> list(lustre@vdom@vnode:element(MUB)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(MTX), selector()) -> list(lustre@vdom@vnode:element(MTX)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(MTJ)), 'query'()) -> list(lustre@vdom@vnode:element(MTJ)).
...
-spec find_all_in_children(lustre@vdom@vnode:element(MTF), 'query'()) -> list(lustre@vdom@vnode:element(MTF)).
...
-spec find_all(lustre@vdom@vnode:element(MTB), 'query'()) -> list(lustre@vdom@vnode:element(MTB)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
            case matches(Root, Selector) of
